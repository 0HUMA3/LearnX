  ...
  return (
    <div className='max-w-7xl mx-auto p-4 mt-20'>
      <div className='flex justify-between mb-4'>
        ...
        <Button variant={completed ? "outline" : "default"} className="bg-black text-white" onClick={completed ? handleInCompleteCourse : handleCompleteCourse}>{completed ? <div className='flex items-center'><CheckCircle className='h-4 w-4 mr-2' /> <span>Completed</span></div> : "Mark as completed"}</Button>
      </div>
        ...
        <div className='flex-1 md:w-3/5 h-fit rounded-lg shadow-lg p-4'>
          <div>
            <video
              ...
              controls
              className='w-full h-auto mdLrounded-lg'
